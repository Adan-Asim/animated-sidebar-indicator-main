...
import { Form, Row, Col, Button, InputGroup, FormControl, select } from 'react-bootstrap'
...
export default function SubmitPropertyRequest(props) {
    ...
    function submit(event) {
        ...
        axios.post('http://localhost:4000/SubmittedPropertyRequests/create-propertyRequest', property)
            .then(res => {
